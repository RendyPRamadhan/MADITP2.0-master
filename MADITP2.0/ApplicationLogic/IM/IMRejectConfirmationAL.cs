...
{
    class IMRejectConfirmationAL
    {
        private clsGlobal Helper;
        private IMRejectConfirmationDA Model;

        public IMRejectConfirmationAL(clsGlobal helper)
        {
            Helper = helper;
            Model = new IMRejectConfirmationDA(Helper);
        }
